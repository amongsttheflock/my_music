...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'Ohsoosecret'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/jimmypesto/Pulpit/my_music_db/music.db'
Bootstrap(app)
db = SQLAlchemy(app)
...
class Format(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(60))
    albums = db.relationship('Album', backref='format', lazy=True)
